...
//
// You can write your custom code in the new-appointment-topic.component.tns.ts file instead.
...
@Component({
    templateUrl: './new-appointment-topic.component.html',
    styleUrls: ['./new-appointment-topic.component.css']
})
export class NewAppointmentTopicViewBaseComponent {
    public $config = {};
