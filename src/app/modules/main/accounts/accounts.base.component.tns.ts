...
//
// You can write your custom code in the accounts.component.tns.ts file instead.
...
export class AccountsViewBaseComponent {
    public $config = {};

    public $accountsService: CollectionDataService<Account>;
    ...
    protected initDataServices(dataConfig: { [key: string]: KinveyServiceConfig }) {
        this.$accountsService = this.$serviceFactory.collection<Account>({
            config: dataConfig.accounts,
            initialState: {
                skip: 0,
                take: 20
            },
